  ...
  return (
    ...
    >
      <div className="relative w-full">
        {isLoading && (
          <span className="!bg-gray-50 loading loading-ring absolute left-1/2 top-1/2 z-40 !h-24 !w-24 -translate-x-1/2 -translate-y-1/2"></span>
        )}
        <video
          className="w-full"
          ref={vidRef}
        ...
        {!isPlaying && (
          <div className="bg-gray-900/50 animate-opacity absolute -inset-x-4 bottom-0 h-24 translate-y-1/4 blur-lg"></div>
        )}
            ...
            >
              {isPlaying ? (
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="fill-gray-50 animate-opacity h-14 w-14 drop-shadow-lg duration-100 ease-in group-hover:scale-[1.05]"
                >
                  <path
                    fillRule="evenodd"
